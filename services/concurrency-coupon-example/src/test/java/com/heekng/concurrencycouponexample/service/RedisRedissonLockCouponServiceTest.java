...
@SpringBootTest
class RedisRedissonLockCouponServiceTest {

    @Autowired
    private RedisRedissonLockCouponService couponService;
    @Autowired
    ...
    @Test
    @DisplayName("RedisRedissonLock을 이용한 동시성 해결")
    void RedisRedissonLock을_이용한_동시성_해결() throws Exception {
        // given
