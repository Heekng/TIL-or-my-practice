...
@SpringBootTest
class RedisLettuceLockCouponServiceTest {

    @Autowired
    private RedisLettuceLockCouponService couponService;
    @Autowired
    ...
    @Test
    @DisplayName("RedisLettuceLock을 이용한 동시성 해결")
    void RedisLettuceLock을_이용한_동시성_해결() throws Exception {
        // given
